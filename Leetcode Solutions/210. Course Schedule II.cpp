...
Follow up :
    - Return if course completion is possible
        -> Ref : 207. Course Schedule
...
public:
    vector<int> findOrder(int numCourses, vector<vector<int>>& prerequisites) {
        ...
        //if asked to return the order of course completion also, then do topological sort
        ...
        if(zero_dependency != numCourses) return {};
